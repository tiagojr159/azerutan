...
<br><br>
Adicionar nome:
	<form action="crud_consulta.php" method="get" name="dados">
<input type='hidden' name='action' size='30' value='adicionar_viagem'  />
<input type='hidden'  id="nome_colaborador" size='30' value=''  />
<input type='text' name='nome' size='30'id='autocomplete-ajax-bairro' style='text-transform: uppercase' />
	 <input type="submit" name="editar" value="Adicionar na lista" />   
</form>
