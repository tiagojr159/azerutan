        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Veja a lista de pessoas matriculadas para a Paixão de Cristo deste ano.</p>
                        <a href="lista.php" class="btn btn-primary">Lista de Candidatos</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://chat.whatsapp.com/CKvK1IcvC0E69CsnXZLtaC">
                            <img src="../projeto/images/icone/whatsapp-icon-logo-BDC0A8063B-seeklogo.com.png" alt="WhatsApp" width="50">
                        </a>
                    </div>
                </div>
            </div>
        ...
        function validarCPF(cpf) {
            if (cpf.value.length > 0) {
                $.ajax({
                    ...
                    type: 'GET',
                    data: { cpf: cpf, action: 'valida_cpf' },
